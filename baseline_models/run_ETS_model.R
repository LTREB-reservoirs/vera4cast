...
for (i in rerun_dates){
  ...
  ETS_met <- fableETS(targets = targets_met,
                               h = 35,
                               model_id = team_name,
                               forecast_date = curr_reference_datetime,
                               site = 'fcre',
  ...
  ETS_insitu <- purrr::pmap_dfr(site_var_combinations,
                                                .f = ~ fableETS(targets = targets_insitu,
                                                                 h = 35,
                                                                 model_id = team_name,
                                                                 forecast_date = curr_reference_datetime,
                                                                 depth = 'target',
  ...
  site_var_combinations_deeper_depth_fcr <- expand.grid(var = c('DO_mgL_mean',
                                                        ...
                                                        site = 'fcre',
                                                        depth = 9)
  ETS_insitu_deeper_fcr <- purrr::pmap_dfr(site_var_combinations_deeper_depth_fcr,
                                                           .f = ~ fableETS(targets = targets_insitu,
                                                                            h = 35,
                                                                            model_id = team_name,
                                                                            forecast_date = curr_reference_datetime,
  ...
  ETS_insitu_deeper_bvr <- purrr::pmap_dfr(site_var_combinations_deeper_depth_bvr,
                                                           .f = ~ fableETS(targets = targets_insitu,
                                                                            h = 35,
                                                                            model_id = team_name,
                                                                            forecast_date = curr_reference_datetime,
  ...
  ETS_ghg_insitu <- purrr::pmap_dfr(site_var_combinations_ghg_insitu,
                                                    .f = ~ fableETS(targets = targets_insitu,
                                                                     h = 35,
                                                                     model_id = team_name,
                                                                     forecast_date = curr_reference_datetime,
  ...
  ETS_insitu_productivity <- purrr::pmap_dfr(site_var_combinations_productivity,
                                                             .f = ~ fableETS(targets = targets_insitu,
                                                                              h = 35,
                                                                              forecast_date = curr_reference_datetime,
                                                                              depth = 'target',
  ...
  ETS_insitu_chla_max <- purrr::pmap_dfr(site_var_combinations_chla_max,
                                                         .f = ~ fableETS(targets = targets_cmax,
                                                                          h = 35,
                                                                          forecast_date = curr_reference_datetime,
                                                                          depth = 'target',
                                                                          ...))
  ...
  ETS_insitu_chem <- purrr::pmap_dfr(site_var_combinations_chem,
                                                     .f = ~ fableETS(targets = targets_insitu,
                                                                      h = 35,
                                                                      forecast_date = curr_reference_datetime,
                                                                      depth = 'target',
  ...
  site_var_combinations_deeper_depth_fcr <- expand.grid(var = c('TN_ugL_sample',
                                                        ...
                                                        site = 'fcre',
                                                        depth = 9)
  ETS_chem_deeper_fcr <- purrr::pmap_dfr(site_var_combinations_deeper_depth_fcr,
                                           .f = ~ fableETS(targets = targets_insitu,
                                                           h = 35,
                                                           model_id = team_name,
                                                           forecast_date = curr_reference_datetime,
  ...
  ETS_chem_deeper_bvr <- purrr::pmap_dfr(site_var_combinations_deeper_depth_bvr,
                                           .f = ~ fableETS(targets = targets_insitu,
                                                           h = 35,
                                                           model_id = team_name,
                                                           forecast_date = curr_reference_datetime,
  ...
  ETS_insitu_physical <- purrr::pmap_dfr(site_var_combinations_physical,
                                                         .f = ~ fableETS(targets = targets_insitu,
                                                                          h = 35,
                                                                          forecast_date = curr_reference_datetime,
                                                                          depth = 'target',
  ...
  ETS_insitu_metals <- purrr::pmap_dfr(site_var_combinations_metals,
                                                       .f = ~ fableETS(targets = targets_insitu,
                                                                        h = 35,
                                                                        forecast_date = curr_reference_datetime,
                                                                        depth = 'target',
                                                                        ...))
  ETS_insitu_metals$duration <- 'P1D'
  ...
  ETS_flux <- purrr::pmap_dfr(site_var_combinations,
                                              .f = ~ fableETS(targets = targets_insitu,
                                                               h = 35,
                                                               model_id = team_name,
                                                               forecast_date = curr_reference_datetime,
  ...
  ETS_insitu_binary <- purrr::pmap_dfr(binary_site_var_comb,
  ...
  # combine and submit
  combined_ETS <- bind_rows(ETS_inflow, ETS_insitu, ETS_met, ETS_flux, ETS_insitu_binary,
                                            ETS_ghg_insitu, ETS_insitu_productivity, ETS_insitu_chem, ETS_insitu_physical, ETS_insitu_metals,
                                            ETS_insitu_chla_max, ETS_insitu_deeper_fcr, ETS_insitu_deeper_bvr, ETS_chem_deeper_bvr, ETS_chem_deeper_fcr)

  # write forecast file
  file_date <- combined_ETS$reference_datetime[1]

  forecast_file <- paste0(paste("daily", file_date, team_name, sep = "-"), ".csv.gz")

  write_csv(combined_ETS, forecast_file)
