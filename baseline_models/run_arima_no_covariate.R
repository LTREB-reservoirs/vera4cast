...
for (i in rerun_dates){
  ...
  bvr_bottom_depth <- targets_insitu |>
    filter(site_id == 'bvre',
           datetime == curr_reference_datetime)

  ## programatically assign "deep" sample depth
  # fcr_bottom_depth <- 9
  # bvr_bottom_depth <- 10
  ...
  arima_nc_inflow <- purrr::map_dfr(.x = c('Flow_cms_mean', 'Temp_C_mean'),
                                               .f = ~ generate_baseline_arima_no_covariate(targets = targets_tubr,
                                                                                                h = 35,
                                                                                                model_id = team_name,
  ...
  arima_nc_met <- generate_baseline_arima_no_covariate(targets = targets_met,
                                                                       h = 35,
                                                                       model_id = team_name,
                                                                       forecast_date = curr_reference_datetime,
                                                                       site = 'fcre',
  ...
  arima_nc_insitu <- purrr::pmap_dfr(site_var_combinations,
  ...
  arima_nc_insitu_deeper_bvr <- purrr::pmap_dfr(site_var_combinations_deeper_depth_bvr,
                                                           .f = ~ generate_baseline_arima_no_covariate(targets = targets_insitu,
                                                                                                            h = 35,
                                                                                                            model_id = team_name,
                                                                                                            forecast_date = curr_reference_datetime,
  ...
  arima_nc_insitu_productivity <- purrr::pmap_dfr(site_var_combinations_productivity,
                                                             .f = ~ generate_baseline_arima_no_covariate(targets = targets_insitu,
                                                                                                              h = 35,
                                                                                                              forecast_date = curr_reference_datetime,
                                                                                                              depth = 'target',
  ...
  arima_nc_insitu_chla_max <- purrr::pmap_dfr(site_var_combinations_chla_max,
                                                         .f = ~ generate_baseline_arima_no_covariate(targets = targets_cmax,
                                                                                                          h = 35,
                                                                                                          forecast_date = curr_reference_datetime,
                                                                                                          depth = 'target',
                                                                                                          ...))
  ...
  arima_nc_insitu_chem <- purrr::pmap_dfr(site_var_combinations_chem,
                                                     .f = ~ generate_baseline_arima_no_covariate(targets = targets_insitu,
                                                                                                      h = 35,
                                                                                                      forecast_date = curr_reference_datetime,
                                                                                                      depth = 'target',
  ...
  site_var_combinations_deeper_depth_fcr <- expand.grid(var = c('TN_ugL_sample',
                                                                ...
                                                                'DOC_mgL_sample',
                                                                'DC_mgL_sample',
                                                                'DN_mgL_sample'), # 'CH4_umolL_sample' (NEED TO ADD THIS BACK IN - BREAKING EVERYTHING RIGHT NOW)
                                                        site = 'fcre',
                                                        depth = 9)
  arima_nc_chem_deeper_fcr <- purrr::pmap_dfr(site_var_combinations_deeper_depth_fcr,
                                                .f = ~ generate_baseline_arima_no_covariate(targets = targets_insitu,
                                                                                            h = 35,
                                                                                            model_id = team_name,
                                                                                            forecast_date = curr_reference_datetime,
  ...
  arima_nc_chem_deeper_bvr <- purrr::pmap_dfr(site_var_combinations_deeper_depth_bvr,
                                                .f = ~ generate_baseline_arima_no_covariate(targets = targets_insitu,
                                                                                            h = 35,
                                                                                            model_id = team_name,
                                                                                            forecast_date = curr_reference_datetime,
  ...
  arima_nc_insitu_physical <- purrr::pmap_dfr(site_var_combinations_physical,
                                                         .f = ~ generate_baseline_arima_no_covariate(targets = targets_insitu,
                                                                                                          h = 35,
                                                                                                          forecast_date = curr_reference_datetime,
                                                                                                          depth = 'target',
  ...
  arima_nc_insitu_metals <- purrr::pmap_dfr(site_var_combinations_metals,
                                                       .f = ~ generate_baseline_arima_no_covariate(targets = targets_insitu,
                                                                                                        h = 35,
                                                                                                        forecast_date = curr_reference_datetime,
                                                                                                        depth = 'target',
  ...
  arima_nc_flux <- purrr::pmap_dfr(site_var_combinations,
                                              .f = ~ generate_baseline_arima_no_covariate(targets = targets_insitu,
                                                                                               h = 35,
                                                                                               model_id = team_name,
                                                                                               forecast_date = curr_reference_datetime,
  ...
  combined_arima_nc <- bind_rows(arima_nc_inflow, arima_nc_insitu, arima_nc_met, arima_nc_flux, arima_nc_insitu_binary,arima_nc_insitu_productivity, arima_nc_insitu_chem, arima_nc_insitu_physical, arima_nc_insitu_metals,
                                 arima_nc_insitu_chla_max, arima_nc_insitu_deeper_fcr, arima_nc_insitu_deeper_bvr, arima_nc_chem_deeper_fcr, arima_nc_chem_deeper_bvr)
